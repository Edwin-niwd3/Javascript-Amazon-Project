To run this program, no special necessities are required. Simply ensure that all files are downloaded and in the proper folder, and the program should run just fine.
